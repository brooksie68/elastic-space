...
- The lab page: the name/line/facts card removed, the card capped at its own controls, the find box + SOUND + FIRE gone from the bar. Sim 122,904 green, lab smoke clean. Meshy total 270 cr.
...
- Added independent flame speeds and detached fading wisps with live controls.
  Verified behavior before researching volumetric, baked and other browser fire
  approaches. Findings: `tmp/fireplace/fire-research.md`. Agent: Codex.
