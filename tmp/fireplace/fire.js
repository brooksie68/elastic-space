...
const names={count:'Flame count',height:'Flame height',speed:'Movement speed',brightness:'Flame brightness',embers:'Ember glow',light:'Firelight',zoom:'Zoom',text:'Text size'};
