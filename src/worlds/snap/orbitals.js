// Snap! — orbital physics module (the Valence Lab's, extended to all eighteen bench elements 2026-09-05).
// Used by scope.js (browser). Slater's s/p rules cover exactly hydrogen through argon.
...
const RAW = [
  ...
  { symbol: 'He', name: 'Helium',     Z: 2,  neutrons: 2,  fill: { '1s': 2 } },
  { symbol: 'Li', name: 'Lithium',    Z: 3,  neutrons: 4,  fill: { '1s': 2, '2s': 1 } },
  { symbol: 'Be', name: 'Beryllium',  Z: 4,  neutrons: 5,  fill: { '1s': 2, '2s': 2 } },
  { symbol: 'B',  name: 'Boron',      Z: 5,  neutrons: 6,  fill: { '1s': 2, '2s': 2, '2p': 1 } },
  ...
  { symbol: 'F',  name: 'Fluorine',   Z: 9,  neutrons: 10, fill: { '1s': 2, '2s': 2, '2p': 5 } },
  { symbol: 'Ne', name: 'Neon',       Z: 10, neutrons: 10, fill: { '1s': 2, '2s': 2, '2p': 6 } },
  { symbol: 'Na', name: 'Sodium',     Z: 11, neutrons: 12, fill: { '1s': 2, '2s': 2, '2p': 6, '3s': 1 } },
  { symbol: 'Mg', name: 'Magnesium',  Z: 12, neutrons: 12, fill: { '1s': 2, '2s': 2, '2p': 6, '3s': 2 } },
  { symbol: 'Al', name: 'Aluminium',  Z: 13, neutrons: 14, fill: { '1s': 2, '2s': 2, '2p': 6, '3s': 2, '3p': 1 } },
  { symbol: 'Si', name: 'Silicon',    Z: 14, neutrons: 14, fill: { '1s': 2, '2s': 2, '2p': 6, '3s': 2, '3p': 2 } },
  { symbol: 'P',  name: 'Phosphorus', Z: 15, neutrons: 16, fill: { '1s': 2, '2s': 2, '2p': 6, '3s': 2, '3p': 3 } },
  { symbol: 'S',  name: 'Sulfur',     Z: 16, neutrons: 16, fill: { '1s': 2, '2s': 2, '2p': 6, '3s': 2, '3p': 4 } },
  { symbol: 'Cl', name: 'Chlorine',   Z: 17, neutrons: 18, fill: { '1s': 2, '2s': 2, '2p': 6, '3s': 2, '3p': 5 } },
